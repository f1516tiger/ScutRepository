...
namespace ZyGames.Framework.Script
{
    ...
    public class ScriptEngines
    {
        ...
        /// <returns></returns>
        public static ScriptScope ExecutePythonSource(string sources, string[] refAssemblies, Microsoft.Scripting.SourceCodeKind codeKind = Microsoft.Scripting.SourceCodeKind.Statements)
        {
            if (IsCompiling) return null;
